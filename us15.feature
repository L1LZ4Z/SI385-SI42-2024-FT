//HU15
Feature: Como estudiante Quiero configurar la información académica y profesional de mi cuenta Para poder mostrar información que destaque progreso académico profesional
 #---------------------------------
  Scenario Outline: Empezar ajustes

   Given el usuario se encuentra la configuración de su perfil de usuario

   When el usuario hace click en modificar información académica y profesional
 ...
 #---------------------------------
  Scenario Outline: Guardar cambios
   ...
   Given el usuario ha realizado cambios en los campos de información académica y profesional
